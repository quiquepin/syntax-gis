...
This package contains:
   ...
   Magnolia Core 5.2.7
   Magnolia Internationalization Framework 5.2.7
   Magnolia JAAS 5.2.7
   Magnolia Imaging Module 3.0.5
   Magnolia Legacy UI 5.2.3
   magnolia-module-mail 5.1.3
   Magnolia Rendering 5.2.7
   Magnolia Templating 5.2.7
   Magnolia Templating for JSP 5.2.7
...
More information about this release can be found at:
    http://documentation.magnolia-cms.com/releases/5.2.7.html
